...
export {
  default as AisClearRefinements,
...
export {
  default as AisHierarchicalMenu,
} from './components/HierarchicalMenu.vue';
...
export { default as AisNumericMenu } from './components/NumericMenu.vue';
